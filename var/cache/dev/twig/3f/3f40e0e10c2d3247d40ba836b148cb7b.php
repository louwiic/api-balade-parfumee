...
class __TwigTemplate_7eb49e1eb5f58d12f97aebfe5378ef14 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"metrics\">
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 158, $this->source); })()), "symfonylts", [], "any", false, false, false, 158)) {
            ...
            // line 163
            echo ((twig_in_filter(twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 163, $this->source); })()), "symfonystate", [], "any", false, false, false, 163), ["eom", "eol"])) ? ("ended on") : ("until"));
            echo "</span>
                </div>
            ";
        }
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/config.html.twig", "/Users/loic/Dev/symfony/bld_parfumee-api_hostinger/vendor/symfony/web-profiler-bundle/Resources/views/Collector/config.html.twig");
    }
}
