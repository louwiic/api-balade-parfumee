...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\CheckListController' => 'getCheckListControllerService',
            'App\\Controller\\FragranceController' => 'getFragranceControllerService',
            'App\\Controller\\LayeringsController' => 'getLayeringsControllerService',
            'App\\Controller\\MailChimpController' => 'getMailChimpControllerService',
            'App\\Controller\\PerfumeTrialSheetController' => 'getPerfumeTrialSheetControllerService',
            'App\\Controller\\ProfilController' => 'getProfilControllerService',
            'App\\Controller\\ReviewPerfumeNoteController' => 'getReviewPerfumeNoteControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('7fL+qjS-+z', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('H9flREgKQb', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jSHSHdfdvB', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3PvFGSucmd', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\CategoryNotificationRepository' => ['privates', 'App\\Repository\\CategoryNotificationRepository', 'getCategoryNotificationRepositoryService', true],
            'App\\Repository\\CheckListRepository' => ['privates', 'App\\Repository\\CheckListRepository', 'getCheckListRepositoryService', true],
            'App\\Repository\\CodeValidationRepository' => ['privates', 'App\\Repository\\CodeValidationRepository', 'getCodeValidationRepositoryService', true],
            'App\\Repository\\ContentExclusiveRepository' => ['privates', 'App\\Repository\\ContentExclusiveRepository', 'getContentExclusiveRepositoryService', true],
            'App\\Repository\\ContentTagRepository' => ['privates', 'App\\Repository\\ContentTagRepository', 'getContentTagRepositoryService', true],
            'App\\Repository\\CreatedAtRepository' => ['privates', 'App\\Repository\\CreatedAtRepository', 'getCreatedAtRepositoryService', true],
            'App\\Repository\\FragranceRepository' => ['privates', 'App\\Repository\\FragranceRepository', 'getFragranceRepositoryService', true],
            'App\\Repository\\LayeringRepository' => ['privates', 'App\\Repository\\LayeringRepository', 'getLayeringRepositoryService', true],
            'App\\Repository\\MyFavoriteTypesOfPerfumesRepository' => ['privates', 'App\\Repository\\MyFavoriteTypesOfPerfumesRepository', 'getMyFavoriteTypesOfPerfumesRepositoryService', true],
            ...
            'App\\Repository\\PerfumeTrialSheetRepository' => ['privates', 'App\\Repository\\PerfumeTrialSheetRepository', 'getPerfumeTrialSheetRepositoryService', true],
            'App\\Repository\\ProfilRepository' => ['privates', 'App\\Repository\\ProfilRepository', 'getProfilRepositoryService', true],
            'App\\Repository\\ReviewPerfumeNoteRepository' => ['privates', 'App\\Repository\\ReviewPerfumeNoteRepository', 'getReviewPerfumeNoteRepositoryService', true],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', true],
            'App\\Repository\\WishlistRepository' => ['privates', 'App\\Repository\\WishlistRepository', 'getWishlistRepositoryService', true],
        ], [
            'App\\Repository\\CategoryNotificationRepository' => '?',
            'App\\Repository\\CheckListRepository' => '?',
            'App\\Repository\\CodeValidationRepository' => '?',
            'App\\Repository\\ContentExclusiveRepository' => '?',
            'App\\Repository\\ContentTagRepository' => '?',
            'App\\Repository\\CreatedAtRepository' => '?',
            'App\\Repository\\FragranceRepository' => '?',
            'App\\Repository\\LayeringRepository' => '?',
            'App\\Repository\\MyFavoriteTypesOfPerfumesRepository' => '?',
            'App\\Repository\\NotificationRepository' => '?',
            'App\\Repository\\PerfumeTrialSheetRepository' => '?',
            'App\\Repository\\ProfilRepository' => '?',
            'App\\Repository\\ReviewPerfumeNoteRepository' => '?',
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('Symfony\\Component\\Messenger\\Event\\WorkerStartedEvent', [#[\Closure(name: 'messenger.listener.stop_worker_on_sigterm_signal_listener', class: 'Symfony\\Component\\Messenger\\EventListener\\StopWorkerOnSigtermSignalListener')] fn () => ($container->privates['messenger.listener.stop_worker_on_sigterm_signal_listener'] ?? $container->load('getMessenger_Listener_StopWorkerOnSigtermSignalListenerService')), 'onWorkerStarted'], 100);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        return $container->services['http_kernel'] = new \Symfony\Component\HttpKernel\HttpKernel($a, new \Symfony\Component\HttpKernel\Controller\TraceableControllerResolver(new \Symfony\Bundle\FrameworkBundle\Controller\ControllerResolver($container, ($container->privates['monolog.logger.request'] ?? self::getMonolog_Logger_RequestService($container))), $b), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), new \Symfony\Component\HttpKernel\Controller\TraceableArgumentResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver(($container->privates['argument_metadata_factory'] ??= new \Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadataFactory()), new RewindableGenerator(function () use ($container) {
            ...
            yield 1 => ($container->privates['.debug.value_resolver.doctrine.orm.entity_value_resolver'] ?? $container->load('get_Debug_ValueResolver_Doctrine_Orm_EntityValueResolverService'));
    ...
    {
        return $container->privates['.service_locator.tpD_zef'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pJF85bZCFg', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('I0Rn-1+AL6', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('huBisAmsd8', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cT-6tnUJY0', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mnmUgDPmQy', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GEgGoSEzR4', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
