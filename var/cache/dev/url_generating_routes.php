...
return [
    ...
    'app_updateNotification' => [['notification'], ['_controller' => 'App\\Controller\\AdminController::updateNotification'], [], [['variable', '/', '[^/]++', 'notification', true], ['text', '/api/admin/notification']], [], [], []],
    ...
    'app_create_checkList' => [['m', 'Y'], ['m' => false, 'Y' => false, '_controller' => 'App\\Controller\\CheckListController::createCheckList'], [], [['variable', '/', '[^/]++', 'Y', true], ['variable', '/', '[^/]++', 'm', true], ['text', '/api/checkList']], [], [], []],
    ...
    'app_getAllFragrance' => [[], ['_controller' => 'App\\Controller\\FragranceController::getAllFragrance'], [], [['text', '/fragrance']], [], [], []],
    'app_create_wishlist' => [['fragrance'], ['fragrance' => null, '_controller' => 'App\\Controller\\FragranceController::createWishlist'], [], [['variable', '/', '[^/]++', 'fragrance', true], ['text', '/api/wishlist']], [], [], []],
    ...
    'generate_code' => [[], ['_controller' => 'App\\Controller\\UserController::generateCode'], [], [['text', '/generate_code']], [], [], []],
    'verify_code' => [[], ['_controller' => 'App\\Controller\\UserController::verifyCode'], [], [['text', '/verify_code']], [], [], []],
